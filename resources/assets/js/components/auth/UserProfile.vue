        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <p>Jouw levering is op volgende ronde  : {{user.shippinground.name}}</p>
                                  <p>{{user.shippinground.description}}</p>
                                  <p><router-link v-if=user.shippinground.file1 :to="user.shippinground.file1" target="_blank">Extra info 1 - leveringsdatums van uw ronde</router-link></p>
                                  <p><router-link v-if=user.shippinground.file2 :to="user.shippinground.file2" target="_blank">Extra info 2 - laatste productenlijst</router-link></p>
                                  <p><router-link v-if=user.shippinground.file3 :to="user.shippinground.file3" target="_blank">Extra info 3 - {{user.shippinground.file3}}</router-link></p>
